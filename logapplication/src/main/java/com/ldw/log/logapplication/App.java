package com.ldw.log.logapplication;
...
import com.ldw.log.logapplication.service.ILogRemoteAidlInterface;
...
public class App extends Application {
    ...
    public void onCreate() {
        super.onCreate();
        initLogRemoteService();
    }
    public void initLogRemoteService() {
        if (myBinder == null) {
